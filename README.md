...
- Persistir el texto extraído de cada documento (`documents.ExtractedText`, [ADR-012](docs/adr/ADR-012-texto-extraido-persistido.md)) para poder **reindexar sin volver a subir los ficheros**: cambiar el troceado obliga hoy a resubirlos, y con la afinación de la recuperación ese pendiente ya tuvo un coste real.
